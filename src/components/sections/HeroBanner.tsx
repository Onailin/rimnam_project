  ...
  return (
    <section className="bg-background pt-24 pb-4 sm:pt-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative aspect-[21/9] w-full min-h-[260px] max-h-[min(44vw,440px)] sm:min-h-[280px]">
            <Image
            ...
            <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 py-8 text-center sm:px-8 sm:py-10">
              <motion.div
                ...
                className="max-w-2xl"
              >
                <p className="luxury-eyebrow mb-2.5 text-champagne">
                  {locale === "th"
                ...
                <h1 className="text-2xl font-medium leading-tight tracking-tight text-white sm:text-4xl lg:text-[2.75rem]">
              ...
              >
                <div className="rounded-xl bg-white/95 p-1.5 shadow-[0_8px_32px_rgba(0,0,0,0.12)] backdrop-blur-md ring-1 ring-white/20">
                ...
                <div className="mt-3 flex flex-col items-center justify-center gap-2.5 sm:flex-row">
                  <button
                    ...
                    className="soft-btn soft-btn-primary inline-flex h-10 items-center gap-2 px-6 text-sm font-medium"
                  >
                    {ctaLabels[locale]}
                  ...
                  <button
                    ...
                    className="soft-btn inline-flex h-10 items-center gap-2 border border-white/25 bg-white/10 px-6 text-sm font-medium text-white backdrop-blur-sm transition-colors hover:bg-white/20"
                  >
        ...
        <motion.div
          ...
          className="relative z-10 -mt-5 mx-auto max-w-xl sm:-mt-6 sm:max-w-2xl"
        >
          <div className="flex divide-x divide-border/80 overflow-hidden rounded-xl border border-border/60 bg-white/95 shadow-[0_8px_28px_rgba(0,0,0,0.07)] backdrop-blur-md dark:bg-surface-alt/95">
            {stats.map((stat) => (
              <div key={stat.value} className="flex-1 px-4 py-3.5 text-center sm:py-4">
                <div className="text-xl font-medium text-wood-dark sm:text-2xl">
                  {stat.value}
                </div>
                <div className="mt-0.5 text-[10px] uppercase tracking-widest text-text-soft sm:text-[11px]">
                  {stat.label[locale]}
                </div>
              </div>
            ))}
